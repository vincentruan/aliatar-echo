module.exports = {
    title: 'alistar',
    description: '使用alistar快速构建web应用程序',
    base: '/alistar/',
    head: [
        ...
        nav: [
            ...
            {text: '更多',
                items:[
                    ...
                    {text:'ChangeLog',link:'https://github.com/enilu/alistar/blob/master/CHANGELOG.md'}
                ]
            },
            {text: '捐赠',link:'/donate'},
            {text: '资源',link:'/resource'},

            {text: 'Gitee', link: 'https://gitee.com/enilu/alistar'},
