...
org.evue.alistar.api.interceptor.JwtFilter中配置拦截器，拦截要过滤的请求地址，具体请参考源代码
...
完整的示例参考"系统管理"->"用户管理"的代码[/user/index.vue](https://github.com/enilu/alistar/tree/master/flash-vue-admin/src/views/system/user)
