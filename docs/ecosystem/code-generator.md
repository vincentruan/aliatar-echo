...
本项目提供了基于IDEA的插件来生成代码,你可以再idea插件仓库中搜索alistar-generator，或者直接从本地安装插件：alistar-generator/idea-plugin.jar即可
用法如下：
...
- 上面实体类注意事项
    ...
    - 实体类必须继承BaseEntity
- 实体类准备好了后,打开实体类，右键选择Generator(或者Alt+Insert)-->alistar-mvc，弹出如下图所示对话框  
