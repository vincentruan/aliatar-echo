...
- 在mysql中创建数据库 alistar
    ```sql
    CREATE DATABASE IF NOT EXISTS alistar DEFAULT charset utf8 COLLATE utf8_general_ci;
    ```
...
- 如果你是个传统的人；就是想要数据库文件，用传统的方式初始化数据库，点击这里[database.sql](https://gitee.com/enilu/alistar/blob/master/docs/alistar.sql)
